...
class _LoginPageState extends State<LoginPage> with TickerProviderStateMixin {
  ...
  void initState() {
    ...
    _fadeAnimation = Tween<double>(begin: 0.0, end: 1.0).animate(
      CurvedAnimation(parent: _successAnimationController, curve: Curves.easeIn),
    );
  }
    ...
    return Scaffold(
      body: Stack(
        children: [
          ...
          ListenableBuilder(
            listenable: _successAnimationController,
            builder: (context, child) {
              return Visibility(
                visible: _successAnimationController.isAnimating,
