# Script para salvar o banner SA (Segurança na Sedação e Analgesia) no projeto

param(
    [string]$ImagePath
)

$targetPath = "assets\images\banner_sa.png"

Write-Host "`n╔══════════════════════════════════════════════╗" -ForegroundColor Cyan
Write-Host "║    🖼️  Salvando Banner SA no Projeto       ║" -ForegroundColor Cyan
Write-Host "╚══════════════════════════════════════════════╝`n" -ForegroundColor Cyan
...
if (-not $ImagePath) {
    ...
    Write-Host "  .\save-banner-sa.ps1 -ImagePath 'C:\caminho\para\banner_sa.png'`n" -ForegroundColor White
...
try {
    ...
    Write-Host "✓ Banner SA salvo com sucesso em: $targetPath" -ForegroundColor Green
    ...
    Write-Host "   • Banner estático (sem link clicável)" -ForegroundColor Gray
    Write-Host "`n💡 Execute 'flutter run' ou hot reload para ver o banner`n" -ForegroundColor Yellow
